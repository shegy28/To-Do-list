...
/* harmony export */   "pushList": () => (/* binding */ pushList),
/* harmony export */   "pushToLocal": () => (/* binding */ pushToLocal),
/* harmony export */   "showList": () => (/* binding */ showList)
/* harmony export */ });
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
/* harmony import */ var _checkbox_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
...
const addList = () => {
  ...
  obj.description = _const_js__WEBPACK_IMPORTED_MODULE_0__.addTask.value;
  obj.completed = false;
  listArr.push(obj);
};
...
const pushList = () => {
  _const_js__WEBPACK_IMPORTED_MODULE_0__.listItems.innerHTML = '';
  listArr.forEach((obj) => {
    const toDo = `<li>
    ...
    _const_js__WEBPACK_IMPORTED_MODULE_0__.listItems.innerHTML += toDo;
    _const_js__WEBPACK_IMPORTED_MODULE_0__.addTask.value = '';
  });
  ...
  checkBox.forEach((tick) => {
    tick.addEventListener('change', (e) => {
      if (e.currentTarget.checked) {
        ...
        (0,_checkbox_js__WEBPACK_IMPORTED_MODULE_1__.completedTrue)(listArr, tickId);
        pushToLocal();
      } else {
        const dataSet = parseInt(tick.dataset.id, 10);
        const tickId = listArr.findIndex((object) => object.index === dataSet);
        (0,_checkbox_js__WEBPACK_IMPORTED_MODULE_1__.completedFalse)(listArr, tickId);
        pushToLocal();
      }
    });
  });
...
/* harmony import */ var _modules_displayList_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
...
window.addEventListener('load', () => {
  (0,_modules_displayList_js__WEBPACK_IMPORTED_MODULE_1__.showList)();
});

_modules_const_js__WEBPACK_IMPORTED_MODULE_2__.addTask.addEventListener('keypress', (e) => {
  if (e.key === 'Enter') {
    if (_modules_const_js__WEBPACK_IMPORTED_MODULE_2__.addTask.value === '') {
      _modules_const_js__WEBPACK_IMPORTED_MODULE_2__.addTask.innerText += "To-Do list can't be empty";
    } else {
      (0,_modules_displayList_js__WEBPACK_IMPORTED_MODULE_1__.addList)();
      (0,_modules_displayList_js__WEBPACK_IMPORTED_MODULE_1__.pushList)();
      (0,_modules_displayList_js__WEBPACK_IMPORTED_MODULE_1__.pushToLocal)();
    }
  }
});

_modules_const_js__WEBPACK_IMPORTED_MODULE_2__.clearAll.addEventListener('click', () => {
  (0,_modules_displayList_js__WEBPACK_IMPORTED_MODULE_1__.clear)();
  (0,_modules_displayList_js__WEBPACK_IMPORTED_MODULE_1__.pushList)();
  (0,_modules_displayList_js__WEBPACK_IMPORTED_MODULE_1__.pushToLocal)();
});
})();
